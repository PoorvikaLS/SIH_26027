...
import MaintenanceIntelligence from "./pages/ai/MaintenanceIntelligence";
import Analytics from "./pages/ai/Analytics";
import WhatIfSimulator from "./pages/ai/WhatIfSimulator";
...
const navItems = [
  ...
  { id: "ai-planning", label: "AI Planning", icon: "✦" },
        ...
        <header className="topbar">
          <div>
            <div className="breadcrumb">
              CONTROL ROOM / {pageTitle.toUpperCase()}
            </div>
...
function BlockPlanner({ notify }) {
  ...
  const filteredTasks = tasks.filter((t) =>
    filtered.some((b) => b.taskIds.includes(t.id))
  );
  ...
  const taskList = (block) =>
    tasks.filter((t) => block.taskIds.includes(t.id));
  ...
  return (
    <div className="planner-page">
      <section className="planner-intro">
        <div>
          <div className="eyebrow">
            OPERATIONS CONTROL · SOUTH WESTERN ZONE
          </div>

          <h2>Block Planning</h2>

          <p>
            Coordinate maintenance possessions with train
        ...
        <button
          ...
          onClick={() =>
            notify(
              "New block request form is ready for Control Office review."
            )
          }
        >
          ＋ Request a block
      ...
      <section className="planner-stats">
        ...
        <div className={conflicts.length ? "stat-alert" : ""}>
          <small>TRAFFIC CONFLICTS</small>
          <strong>{conflicts.length}</strong>
        </div>

        <div>
          <small>DEPARTMENTS COORDINATED</small>
          <strong>
            {
              new Set(
                filtered.flatMap((b) => b.departments)
              ).size
            }
          </strong>
        </div>
      ...
      <section className="card planner-filters">
        <div className="planner-filter-heading">
          <div>
            <strong>Plan filters</strong>
            <small>
              Refine block schedule and traffic windows
            </small>
          </div>
        ...
        <div className="planner-filter-controls">
          <label>
            Date
            <input
              type="date"
      ...
      <div className="planner-tabs">
        ...
        <button
          className={tab === "traffic" ? "selected" : ""}
          onClick={() => setTab("traffic")}
        >
          Train traffic <span>{trains.length}</span>
        </button>
        ...
        <>
          <section className="card timeline-card">
            <CardHeader
              ...
              subtitle="24-hour view · click any maintenance block for operational detail"
            >
              <span className="ai-chip">● LIVE SCHEDULE</span>
            </CardHeader>

            <Timeline
              blocks={filtered}
              onSelect={setSelected}
              day={week === "week" ? "This week" : date}
            />
          </section>
          ...
          <div className="planner-lower">
            <section className="card task-panel">
              <CardHeader
                ...
                subtitle={`${filteredTasks.length} tasks in filtered plan`}
              />
                ...
                {filteredTasks.map((t) => (
                  <div className="task-row" key={t.id}>
                    ...
                    <div>
                      ...
                      <small>
                        {t.id} · {t.asset} · {t.section}
                      </small>
                    </div>

                    <StatusBadge value={t.priority} />

                    <small className="task-dept">
                      {t.department}
                    </small>
                  </div>
                ))}
            ...
            <section className="card conflict-panel">
              <CardHeader
                title="Traffic conflicts"
                subtitle="Train movements intersecting block windows"
              />
              ...
              <div className="conflict-list">
                ...
                {!conflicts.length && (
                  <div className="clear-conflict">
                    ✓ No train movements intersect the visible block
                    windows.
                  </div>
                )}
              </div>
      ...
      {tab === "network" && (
        <section className="card network-card">
          <CardHeader
            ...
            subtitle="Simplified section status and critical infrastructure"
          />
    ...
    <div className="traffic-page-grid">
      <section className="card">
        <CardHeader
          ...
          subtitle="Scheduled passenger and goods services"
        />
            ...
            <tbody>
              {trains.map((t) => (
                <tr key={t.id}>
                  ...
                  <td>
                    <span
                      className={`train-type ${t.type.toLowerCase()}`}
                    >
                      {t.type}
                    </span>
                  </td>
      ...
      <section className="card forecast-card">
        <CardHeader
          ...
          subtitle="Freight movements in the operating window"
        />

        <div className="forecast-highlight">
          <strong>2</strong>

          <span>goods services forecast</span>

          <small>
            12:50 Hassan – Mangaluru · 23:10 Bengaluru – Tumakuru
          </small>
        </div>
        ...
        <div className="forecast-note">
          ...
          <p>
            Iron Ore Special approaches the planned maintenance window on
            Hassan – Mangaluru. Confirm dispatch clearance before the 11:30
            block.
          </p>
        </div>
      </section>

      <section className="card timeline-card traffic-timeline">
        <CardHeader
          title="Train & possession timeline"
          subtitle="Train markers compared with maintenance windows"
        />
...
function BlockDetails({ block, tasks: blockTasks, onClose }) {
  ...
  return (
    <div className="modal-backdrop" onMouseDown={onClose}>
      <div
        className="modal block-detail-modal"
        onMouseDown={(e) => e.stopPropagation()}
      >
        <div className="modal-header">
          <div>
            <span className="eyebrow">
              BLOCK DETAILS · {block.id}
            </span>
        ...
        <div className="detail-row">
          ...
          <strong>{block.departments.join(" · ")}</strong>
        </div>
        ...
        <div className="detail-section">
          ...
          {blockTasks.map((t) => (
            <div className="detail-task" key={t.id}>
              <span>✓</span>
        ...
        <div className="detail-section why-section">
          <strong>Why this block?</strong>
          <p>{block.why}</p>
        </div>
      </div>
    </div>
    ...
    <>
      <section className="welcome-row">
        <div>
          ...
          <p className="muted">
            Here is the current network status and AI-assisted block outlook.
          </p>
        </div>
      ...
      <section className="dashboard-grid">
        <div className="card risk-card">
          <CardHeader
            ...
            subtitle="Predictive maintenance risk across active corridors"
          >
          ...
          <div className="ai-insight">
            ...
            <p>
              <strong>AI insight:</strong> Combining the pending S&T and
              Engineering activities into the 13:00 corridor window could
              reduce expected downtime by approximately 18 minutes.
            </p>
          </div>
        </div>
        ...
        <div className="card alert-card">
          <CardHeader
            ...
            subtitle="Assets requiring immediate review"
          >
            <button
              className="text-button"
          ...
          <div className="alert-list">
            <AlertItem
              severity="critical"
              title="Point Machine PM-72"
              detail="Availability 84.6% • overdue 2 days"
            />

            <AlertItem
              severity="warning"
              title="Signal Cabin S-204"
              detail="Relay maintenance due today"
            />

            <AlertItem
              severity="warning"
              title="Track Section A-17"
              detail="Inspection window closes in 4h"
            />
          </div>
        </div>
      </section>
      ...
      <section className="card block-card">
        <CardHeader
          title="Today's Block Plan"
          subtitle="Coordinated maintenance windows from BDMS, TMS, SMMS & TDMS"
        >
          <div className="header-actions">
            <button
              className="secondary-button"
              onClick={() =>
                notify("Export prepared for the Control Office.")
              }
            >
              Export
            </button>
        ...
        <div className="filter-row">
          <div className="search-box">
            ...
            <input
              ...
              placeholder="Search blocks, corridors, activities..."
            />
          </div>
              ...
              {!filteredBlocks.length && (
                <tr>
                  <td colSpan="7" className="empty-state">
                    No block plans match your filters.
                  </td>
                </tr>
              )}
            </tbody>
      ...
      <section className="bottom-grid">
        <div className="card availability-card">
          <CardHeader
            title="Asset Availability"
            subtitle="Current infrastructure health"
          >
            <button
              className="text-button"
            ...
            {assets.map((asset) => (
              <div className="asset-row" key={asset.name}>
                <div className="asset-info">
                  <span
                    className={`asset-icon ${asset.type.toLowerCase()}`}
                  >
                    {asset.type[0]}
                  </span>
        ...
        <div className="card activity-card">
          <CardHeader
            ...
            subtitle="Latest control room events"
          />
        ...
        <div className="card traffic-card">
          <CardHeader
            title="Maintenance / Traffic"
            subtitle="24-hour operating outlook"
          />

          <div className="mini-chart">
            {[42, 55, 48, 70, 64, 82, 58, 74, 88, 68, 77, 62].map(
              (height, i) => (
...
function SectionPage({
  ...
  const copy = {
    blocks: [
      "Block Planning",
      "Create, compare and approve weekly/monthly AI-assisted maintenance blocks.",
      "The detailed planner can be connected to your optimization backend here.",
    ],

    maintenance: [
      "Maintenance",
      "Review defects, overdue work and planned maintenance activities.",
      "This screen is ready for API-driven maintenance records.",
    ],

    alerts: [
      "Alerts",
      "Prioritized operational alerts generated from asset and schedule data.",
      "Criticality can later be supplied by the AI/ML service.",
    ],

    analytics: [
      "Analytics",
      "Measure block utilization, downtime reduction and asset availability.",
      "Connect your historical data to turn these cards into live analytics.",
    ],
  };
      ...
      <div className="module-grid">
        <div className="card module-card">
          ...
          <button
            className="primary-button"
            onClick={() =>
              notify(`${heading} module selected.`)
            }
          >
            Continue
          </button>
      ...
      >
        ...
        <label className="setting-row">
          <span>
            ...
            <small>
              Show planner insights on the dashboard.
            </small>
          </span>
        ...
        <label className="setting-row">
          <span>
            ...
            <small>
              Keep critical alerts visible in the topbar.
            </small>
          </span>
